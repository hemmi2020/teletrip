...
// ─── Inline Auth Form (shown when not logged in on /account) ─────────────────
const _InlineAuthForm = () => {
  ...
  return (
    <div>
      ...
      <button onClick={handleGoogle}
        className="w-full flex items-center justify-center gap-3 border border-gray-200 rounded-xl py-2.5 mb-4 hover:bg-gray-50 transition-colors text-sm font-medium text-gray-700">
      ...
      <div className="pt-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="bg-white rounded-lg shadow-sm mb-8">
            ...
            <div className="flex lg:hidden overflow-x-auto border-b border-gray-200" style={{scrollbarWidth:'none'}}>
              {tabs.map(({ id, label, icon: Icon }) => (
                <button
                  key={id}
                  onClick={() => handleTabChange(id)}
                  className={`flex-shrink-0 flex flex-col items-center gap-1 min-w-[80px] min-h-[44px] px-3 py-2 border-b-2 font-medium text-xs transition-colors whitespace-nowrap ${
                    activeTab === id
